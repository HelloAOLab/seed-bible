...
const infoLabelTransformerScales =
  BibleVizUtils.Functions.GetBotScales(thisBot);
...
if (
  ...
  const infoLabelTailScales =
    BibleVizUtils.Functions.GetBotScales(infoLabelTail);
