...
const infoLabel = getBot(
  byTag("isInfoLabel", true),
  byTag("transformer", getID(thisBot)),
  byTag("isInUse", true)
);
const infoLabelTail = getBot(
  byTag("isInfoLabelTail", true),
  byTag("transformer", getID(thisBot)),
  byTag("isInUse", true)
);
const infoLabelDate = getBot(
  byTag("isInfoLabelDate", true),
  byTag("transformer", getID(thisBot)),
  byTag("isInUse", true)
);
const infoLabelUsersColor = getBots(
