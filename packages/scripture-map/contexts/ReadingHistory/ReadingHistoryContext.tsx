import { useReadingHistoryProvider } from "./useReadingHistoryProvider";
import type {
...
export interface ReadingHistoryContextType {
  ...
  setSelectedTimelineKey: Dispatch<StateUpdater<number>>;
  timelineRangeMethod: TimelineRangeMethodType;
  setTimelineRangeMethod: Dispatch<StateUpdater<TimelineRangeMethodType>>;
}
