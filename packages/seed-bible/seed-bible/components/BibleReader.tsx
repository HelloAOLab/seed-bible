...
function renderStaticChapterContent(chapter: TranslationBookChapter | null) {
          ...
          <div ref={swipeViewportRef} className="sb-reader-swipe-viewport">
            <div ref={swipeTrackRef} className="sb-reader-swipe-track">
              <div
                ...
                aria-hidden="true"
              >
                {renderStaticChapterContent(prevChapterPreview)}
              </div>
              <div
                ref={currentPanelRef}
              ...
              <div
                ...
                aria-hidden="true"
              >
                {renderStaticChapterContent(nextChapterPreview)}
              </div>
            </div>
          </div>
