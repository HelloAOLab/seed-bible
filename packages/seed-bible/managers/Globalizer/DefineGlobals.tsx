...
function HandleBookDataInStack(params)
{
    ...
    if(bookData.isSelected)
    {
        ...
        if(bookData instanceof SectionBookData) setTag(bookData.element, "desiredScaleZ", selectedBookHeight);
    ...
    {
        if(bookData instanceof SectionBookData) setTag(bookData.element, "desiredScaleZ", bookData.element.tags.initialScaleZ);
...
function HandleSectionDataInStack(params)
{
    ...
    sectionDeltaPositionZ = nextPositionZ - desiredPositionZ;
...
function HandleTestamentDataInStack(params)
{
    ...
    testamentDeltaPositionZ = nextPositionZ - desiredPositionZ;
...
function GetDialogBotScaleY(scaleXLimit, line, paddingX = 0, paddingY = 0, fontSize = 1.94)
{
    ...
    scaleY = (labelHeight * fontSize * 0.0102 * amountOfLines) + paddingY;
