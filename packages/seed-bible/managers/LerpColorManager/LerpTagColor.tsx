/**
    ...
    * Available tags to be lerped: Defined on InterpolatableColorTags from managers.InstanceManager.defineGlobals.
    ...
    * @example
    * LerpColorManager.LerpTagColor({startingColor: [50, 60, 70], endingColor: [255, 255, 200], durationInSeconds: 2, bot: thisBot,  tag: InterpolatableColorTags.strokeColor});
*/

import { ColorLerpData } from "managers.LerpColorManager.ColorLerpData";
...
return new Promise((resolve, reject) => {
    ...
    intervalId = setInterval(() => {
        ...
        if (i >= divisionFactor) {
            setTagMask(bot, tag, RgbToHex(ClampRGBColor(endingColor)));
