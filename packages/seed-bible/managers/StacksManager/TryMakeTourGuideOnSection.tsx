...
import {TourGuideData} from 'managers.StacksManager.TourGuideData'
...
else
{
    ...
    const bibleTransformerPosition = bibleData && sectionData.isInsideBible ? getBotPosition(thisBot, dimension) : new Vector3(0,0,0);
