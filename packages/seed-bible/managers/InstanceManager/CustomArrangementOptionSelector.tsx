...
const CustomArrangementOptionSelector = ({reset, navigationButtonsInfo, setNavigationButtonsInfo, isEditor, setIsEditor, setSelectedOption, singleOptions, groupOptions}) => {
    ...
    return (
        <>
            <div className="templateWrapper">
                <EditionToggle isEditor={isEditor} setIsEditor={setIsEditor}/>
