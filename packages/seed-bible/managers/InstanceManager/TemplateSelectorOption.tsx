...
const TemplateSelectorOption = ({ draggingId, dragOverInfo, isEditor, title, option, subOptions, handleOptionClick, checkedOption, handleDragStart, handleDragEnter, handleDragEnd }) => {
