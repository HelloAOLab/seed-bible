...
const cameraAnimationToggle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleButton });
const labelsToggle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleButton });
const pathToggle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleButton });
const chapterSelectToggle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleButton });
const showDatesToggle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleButton });
const cameraAnimationToggleBackground = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleBackground });
const showDatesToggleBackground = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleBackground });
const labelsToggleBackground = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleBackground });
const pathToggleBackground = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleBackground });
const chapterSelectToggleBackground = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleBackground });
const cameraAnimationToggleHandle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleHandle });
const showDatesToggleHandle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleHandle });
const labelsToggleHandle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleHandle });
const pathToggleHandle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleHandle });
const chapterSelectToggleHandle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleHandle });
const colorPickerButton = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButton });
const openAllBooksButton = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButton });
const openAllBooksIcon = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButtonIcon });
const openAllBooksLabel = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButtonLabel });
const colorPickerBackground = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapColorPickerBackground });
const colorPickerContent = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapColorPickerContent });
const settingsButton = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapSettingsButton });
const playlistSelectorButton = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButton });
const playlistSelectorIcon = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButtonIcon });
const playlistSelectorLabel = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButtonLabel });
const dateFormatSelectorButton = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButton });
const dateFormatSelectorIcon = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButtonIcon });
const dateFormatSelectorLabel = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapButtonLabel });

const playlistPathToggle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleButton });
const playlistPathToggleBackground = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleBackground });
const playlistPathToggleHandle = ObjectPooler.GetObjectFromPool({ tag: ObjectPoolTags.MapToggleHandle });
...
return { mapBookStructures, staticMapElements, amountOfRows: row, sectionLinesInfo, testamentLinesInfo };