...
switch (dataToNavigate.type) {
    ...
    case "chapter": {
        let book = dataToNavigate.additionalInfo.bookName;
        const chapter = dataToNavigate.type === 'chapter-grouped' ? dataToNavigate.additionalInfo.chapter[0] : dataToNavigate.additionalInfo.chapter;
        // const psalmsDivision = [0, 41 , 72, 89, 106, 150];
    ...
    case "verse": {
        ...
        await globalThis.Open(((dataToNavigate.additionalInfo.data.bookId || dataToNavigate.additionalInfo.chapterData.id || dataToNavigate.additionalInfo.chapterData.bookId)), chapterNo, dataToNavigate.translationId ||  dataToNavigate.additionalInfo.chapterData.translation);
        await os.sleep(20);
