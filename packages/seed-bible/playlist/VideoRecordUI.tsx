...
const IconsRef = {
    'screen&cam': 'https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/5ccb9e853b00fb860c2f5891d26f0960752606951a7aa65f834c9d456cd37b74.svg',
    'screen&cam_active': 'https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/082372063bb71655ac595d8ec562e1db62dce19a36bb9c84e4ae0a650701fcaf.svg',
    'screen': "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/cac667f563e65712a435b025ba07f17654754c19e088ff63a52cee5a604a17d0.svg",
    'screen_active': "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/3083c0ab7b70b79e1af836c500a3c797af134d60bd7cf951b2af3a34460bcb40.svg",
    ...
    'cam_active': "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/3c8826d5457ec79a1d3cf195e47d476a0e04fbee3886f6603a7da03cd6f7a267.svg",
    ...
    "mic_off": "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/0da679456ed172e5d3573982e6140ca4549d215e3db610e0264d43a1ae1f72af.svg",
    "start_recording": "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/733bde47bbd9ed4abc94ddf6bdbe597db886a13b106d150ec7ab2a587856b2bd.svg",
    "stop_recording": "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/1975ce33ad8bee6f1c178167477fc356446715eda8f5bece9958755209297526.svg",
}
...
const VideoRecordUI = ({ data, setData }) => {
    const [recordingProps, setRecordingProps] = useState({
        ...
        screen: globalThis?.VideoRecordTab ? globalThis.VideoRecordTab !== 'cam' : true
    });

    const isScreen = useMemo(() => recordingProps.screen, [recordingProps.screen])
    ...
    const handleRecord = async () => {
        try {
            ...
            await experiment.beginRecording({
                audio: !recordingProps.audio ? false : recordingProps.screen ? ['microphone'] : true,
                video: !recordingProps.screen,
                screen: recordingProps.screen
            });
            if (isScreen) {
                globalThis.isRecording = true;
                console.log("recordingProps.video", recordingProps.video);
    ...
    return <>
        ...
        <div className="tabs-playlist" style={{ width: '100%', marginBottom: '0.5rem' }}>
        ...
        <div className="media-recorder">
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    {!isRecorded && <div className="controls-video">
                        {!isRecording && (
                            <>
                                <p className="pointer"
                                    onClick={() => setRecordingProps(prev => ({
                                        ...prev,
                                        audio: !prev.audio
                                    }))}
                                >
            ...
            {isRecorded && <div className="controls">
