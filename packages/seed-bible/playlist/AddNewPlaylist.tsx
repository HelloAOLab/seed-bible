...
const AddNewPlaylist = ({
    ...
    return <>
        ...
        <div className="add-new-playlist" style={{ border: 'none' }}>
            ...
            <h3>Create new {isLayers ? 'layer' : 'playlist'}</h3>
                ...
                <Button
                    onClick={() => {
                        ...
                        if (selectedTags.length === 8) {
                            return ShowNotification({ message: "Tags limit cannot exceeds 8!", severity: "error" });
                        }
                ...
                <Button
                    onClick={() => {
                        ...
                        const checkNameDuplicate = (newName) => {
                            ...
                            const names = (globalThis[`${id}playlists`] || []).map((ele) => ele.name);
