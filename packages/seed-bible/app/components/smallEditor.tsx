  ...
  function buildToolbarMap(ctx) {
    ...
    const alignDrop = (
      <div className="sre-drop">
        ...
        <div className="sre-drop-menu">
          <button onClick={Cmds.alignLeft}>
            <span className="material-symbols-outlined">format_align_left</span>
          </button>
          <button onClick={Cmds.alignCenter}>
            <span className="material-symbols-outlined">
              format_align_center
            </span>
          </button>
          <button onClick={Cmds.alignRight}>
            <span className="material-symbols-outlined">
              format_align_right
            </span>
          </button>
          <button onClick={Cmds.alignJustify}>
            <span className="material-symbols-outlined">
    ...
    const listDrop = (
      <div className="sre-drop">
        ...
        <div className="sre-drop-menu">
          <button onClick={Cmds.toggleBulletList}>
            <span className="material-symbols-outlined">
              format_list_bulleted
            </span>
          </button>
          <button onClick={Cmds.toggleOrderedList}>
            <span className="material-symbols-outlined">
    ...
    const paragraphDrop = (
      <select className="sre-select" title="Paragraph">
        ...
        <option onClick={() => chainArg("toggleHeading", { level: 1 })}>
          H1
        </option>
        <option onClick={() => chainArg("toggleHeading", { level: 2 })}>
          H2
        </option>
        <option onClick={() => chainArg("toggleHeading", { level: 3 })}>
          H3
        </option>
      </select>
    );
