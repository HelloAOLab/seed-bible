      ...
      {activeTab === "space" ? (
        <div className="settings-content">
          {spaceContentVisibility.spaceIcon !== false && (
            <div
              className={`space-content-item ${spaceContentVisibility.spaceIcon === false ? "hidden-item" : ""}`}
            >
              {editMode && (
                <button
          ...
          {spaceContentVisibility.spaceDescription !== false && (
            <div
              className={`space-content-item ${spaceContentVisibility.spaceDescription === false ? "hidden-item" : ""}`}
            >
              {editMode && (
                <button
                  className="hide-button space-content-hide"
                  ...
                  {items.map(
                    ({
                      ...
                      type === "divider" ? null : (
                        <div
                          key={key}
                          className={`settings-item-container ${hidden ? "hidden-item" : ""}`}
                        >
                              ...
                              <div className="sub-settings-list">
                                {subItems.map(
                                  ({
                                    ...
                                    <div
                                      key={subKey}
                                      className={`settings-item-container ${subHidden ? "hidden-item" : ""}`}
                                    >
                                      <div className="settings-item-wrapper">
                                        {editMode && (
                                          <button
                ...
                {items.map((item) => {
                  ...
                  if (item.type === "desc") {
                    ...
                    return (
                      <div
                        key={item.key}
                        className={`space-description ${hidden ? "hidden-item" : ""}`}
                        style={{ position: "relative" }}
                      >
                        {editMode && (
                          <button
                  ...
                  if (item.type === "section" && item.key === "subscriptions") {
                    ...
                    return (
                      <div
                        key={item.key}
                        className={`general-section ${hidden ? "hidden-item" : ""}`}
                        style={{ position: "relative" }}
                      >
                        {editMode && (
                          <button
                    ...
                    >
                      <div className="settings-item-wrapper">
                        ...
                        >
                          ...
                          <div
                            className={`item-text ${item.style === "disabled" ? "disabled" : ""}`}
                          >
                            {editMode && editingLabel === item.key ? (
                              <input
                                type="text"
