...
const EditorToolbarSettings = () => {
  ...
  const defaultItems = [
    {
      id: "text-select",
      label: "Text Select",
      description: "Choose which text to format (all, headings, verses)",
    },
    ...
    { id: "text-color", label: "Text Color", description: "Change text color" },
    {
      ...
      description: "Change background/highlight color",
    },
    {
      id: "paragraph",
      label: "Paragraph",
    ...
    },
    {
      id: "font-style",
      label: "Font Style",
      description: "Choose font style (normal, bold, italic, light)",
    },
    ...
    { id: "print", label: "Print", description: "Print document" },
    {
      ...
      description: "Adjust vertical padding",
    },
    {
      id: "margin2",
      label: "Horizontal Margin",
      description: "Adjust horizontal padding",
    },
    {
      id: "ai-prompt",
      label: "AI Prompt",
    ...
    },
    {
      id: "download",
      label: "Download",
      description: "Download document as JSON",
    },
  ...
  const getItemDetails = (id) => {
    return (
      defaultItems.find((item) => item.id === id) || {
        id,
        label: id,
        description: "Custom toolbar item",
      }
    );
  };
  ...
  return (
    ...
    >
      ...
      >
        Customize the order of toolbar items. Drag and drop or use the arrow
        buttons to reorder.
      </div>
