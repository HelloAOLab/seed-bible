const { createContext, useRef, useState, useContext, useCallback, useMemo } =
  os.appHooks;
...
const readingHistory = {
  Gabriel: [{ book: "Genesis", chapter: 1, daysAgo: 2 }],
  Craig: [{ book: "Genesis", chapter: 1, daysAgo: 4 }],
  Sujan: [{ book: "Genesis", chapter: 1, daysAgo: 6 }],
  Mazen: [{ book: "Genesis", chapter: 7, daysAgo: 1 }],
  Amir: [{ book: "Genesis", chapter: 7, daysAgo: 1 }],
  Kushagra: [{ book: "Genesis", chapter: 5, daysAgo: 5 }],
};
...
export const BibleLayout2DProvider = ({
  ...
  const maxChapterHeatCount = useMemo(() => {
    return 5;
  }, []);
