  ...
  case pieceData instanceof LayoutBookData:
    {
      ...
      const layoutBookStructure = thisBot.GetBookStructureByChild({
        layoutBookData: pieceData,
      });
  ...
  case pieceData instanceof LayoutChapterData:
    {
      NullifyChapterParentIds(pieceData, [
        nullifiableIds.layoutId,
        nullifiableIds.layoutBookId,
      ]);
...
function NullifyBookParentIds(layoutBookData: any, idsToNullify: any) {
...
function NullifyChapterParentIds(chapterData: any, idsToNullify) {
