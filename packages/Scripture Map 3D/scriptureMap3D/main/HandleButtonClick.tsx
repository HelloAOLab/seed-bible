...
switch (button.tags.buttonType) {
  ...
  case BibleVizUtils.Data.tags.LayoutButtonType.BibleVizUtils.Data.tags
    .DateFormatselectorButton:
    {
      const currentDateFormatIndex = Object.keys(
        BibleVizUtils.Data.tags.DateFormats
      ).findIndex((key) => {
        return (
          BibleVizUtils.Data.tags.DateFormats[key] ===
          layoutData.currentDateFormat
        );
      });
      ...
      const selectedDateformat = await os.showInput(currentDateFormatIndex, {
        ...
        type: "list",
        items: Object.keys(BibleVizUtils.Data.tags.DateFormats).map(
          (dateFormatKey) => {
            return {
  ...
  case BibleVizUtils.Data.tags.LayoutButtonType.CameraAnimationToggle:
    {
      layoutData.isCameraAnimationEnabled =
        !layoutData.isCameraAnimationEnabled;
