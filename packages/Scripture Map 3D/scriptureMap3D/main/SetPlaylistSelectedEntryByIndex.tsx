...
function GetTestamentLineForEntry(entryItem: any) {
  return layoutData.staticLayoutPieces.testamentLines.find(
    (testamentLine: any) => {
      return (
...
function GetBookForEntry(entryItem: any) {
  const layoutBookStructure = layoutData.childrenStructures.find(
    (structure: any) => {
      return (
        structure.layoutBookData.creationInfo.arrangementIndex ===
          entryItem.tags.arrangementIndex &&
        structure.layoutBookData.creationInfo.testamentIndex ==
          entryItem.tags.testamentIndex &&
        structure.layoutBookData.creationInfo.sectionIndex ==
          entryItem.tags.sectionIndex &&
