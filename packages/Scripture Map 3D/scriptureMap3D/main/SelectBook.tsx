...
for (const chapterData of layoutBookData.childrenData) {
  ...
  const chapterMod = {
    ...
    [dimension + "X"]:
      ...
      BibleVizUtils.Data.BibleLayoutMeasurements.ChapterWidth / 2 +
      BibleVizUtils.Data.BibleLayoutMeasurements.ChapterPadding +
      column *
        (BibleVizUtils.Data.BibleLayoutMeasurements.ChapterWidth +
          BibleVizUtils.Data.BibleLayoutMeasurements.ChapterGap),
    [dimension + "Y"]:
      chaptersOriginPosition.y -
      BibleVizUtils.Data.BibleLayoutMeasurements.ChapterHeight / 2 -
      BibleVizUtils.Data.BibleLayoutMeasurements.ChapterPadding -
      row *
        (BibleVizUtils.Data.BibleLayoutMeasurements.ChapterHeight +
          BibleVizUtils.Data.BibleLayoutMeasurements.ChapterGap),
    ...
    initialScaleZ:
      BibleVizUtils.Data.BibleLayoutMeasurements.ChapterInitialScaleZ,
    selectedScaleZ:
      BibleVizUtils.Data.BibleLayoutMeasurements.ChapterSelectedScaleZ,
    desiredLabel:
  ...
  if (
    column >= BibleVizUtils.Data.BibleLayoutMeasurements.BookMaxAmountOfColumns
  ) {
    column = 0;
    row += 1;
  }
