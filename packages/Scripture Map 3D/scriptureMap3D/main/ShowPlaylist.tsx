    ...
    case BibleVizUtils.Data.tags.PlaylistItemType.Verse:
      {
        ...
        const itemPositionZ =
          BibleVizUtils.Data.BibleLayoutMeasurements.BookPositionZ +
          chapterData.playlistEntriesItems.length *
            (playlistEntryItemHeight +
              BibleVizUtils.Data.BibleLayoutMeasurements
        ...
        const entryItemMod = {
          ...
          scaleX:
            ...
            BibleVizUtils.Data.BibleLayoutMeasurements.PlaylistEntryItemPadding,
          scaleY:
...
const coverScales = BibleVizUtils.Functions.GetBotScales(
  layoutData.staticLayoutPieces.cover
);
