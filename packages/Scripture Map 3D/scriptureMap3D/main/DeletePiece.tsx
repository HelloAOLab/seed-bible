...
if (!pieceData) {
  if (piece.tags.isLayoutCover) {
    pieceData = thisBot.vars.layoutsData.find((layoutData: any) => {
...
function DeleteBook(layoutBookData: any) {
  const bookDataIndex = thisBot.vars.layoutBooksData.indexOf(layoutBookData);
  layoutBookData.childrenData.forEach((chapterData: any) => {
...
function DeleteLayout(layoutData: any) {
