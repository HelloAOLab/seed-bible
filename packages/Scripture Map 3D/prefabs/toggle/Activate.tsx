...
const backgroundCurrentColor = BibleVizUtils.Functions.HexToRgb({
...
const layoutData = scriptureMap3DManager.GetMapDataById({
...
ColorLerper.LerpTag({
  ...
  endingColor: BibleVizUtils.Functions.HexToRgb({
    hexColor: thisBot.tags.backgroundActiveColor,
  }),
