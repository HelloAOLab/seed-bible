...
const isChild = (parentId: any, childId) => {
    ...
    for (let i = 0; i < controlBot.tags.linkList.length; i++) {
      if (isChild(controlBot.tags.id, controlBot.tags.linkList[i])) {
        ...
        let playButton = create({
          ...
          form: "sprite",
          formAddress:
            "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/ae0e931d2819a78d59cec25d47d4a242dae0e3b3c3466b5620fc7e0da3f1318b.png",
