...
export function BibleVariablesProvider({ children }) {
    ...
    return (
        <MyContext.Provider value={{ ReSeed, setReSeed, screens, fullScreen, setFullScreen, tools, setTools, setScreens, navFunctions, setNavFunctions, panelMode, setPanelMode, canvasMode, setCanvasMode, mapMode, setMapMode, canvasTools, mapTools, setCanvasTools, setMapTools }}>
            {children}
        </MyContext.Provider>
    );
}
