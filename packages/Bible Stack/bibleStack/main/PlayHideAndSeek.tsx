...
// TO Avoid Section Click Oopen Before Game
...
const { Modal , Button, Loader, Select } = Components;
...
const onNextClick = async ()=>{
    ...
    if(globalThis.hideSeekPlaying) startGameBot.startVerseGuess({
        bookSelected: randomGameBook
    });
}
           ...
           ?
            ...
            :
                <div className="welcome-copy">
                    ...
                    <Select styleCont={{marginTop: '19px'}} value={diffculty} onChangeListener={onChange} name="Difficulty:" options={GUESSING_GAME_DIFFICULTY_OPTIONS}  />
...
const QuitGame = () => {
    ...
    useEffect(()=>{
        ...
        globalThis.hideSeekShowQuitButton = setShowQuitButton;

        return ()=>{
            globalThis.hideSeekShowQuitButton = null;
        }
    },[]);
