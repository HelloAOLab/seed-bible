...
// Render a button inside for the Guessing game
const GUESSING_GAME_ID = "guessing-game-app";
os.unregisterApp(GUESSING_GAME_ID);
os.registerApp(GUESSING_GAME_ID);

const GuessingGameUI = () => {
  return (
    <div
      stlye={{
...
console.log("MAKING YOU IN", GuessingGameUI);
os.compileApp(GUESSING_GAME_ID, <GuessingGameUI />);
...
const arrangementIndex = !isNaN(customArrangementIndex)
  ? customArrangementIndex
  : BibleVizUtils.Functions.GetCurrentArrangementIndex();
