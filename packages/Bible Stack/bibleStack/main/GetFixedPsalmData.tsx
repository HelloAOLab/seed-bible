...
const { chapter } = that;
const psalmInfo = BibleVizUtils.Data.tags.psalmsInfo.find((psalmInfo: any) => {
  return (
    chapter >= psalmInfo.chapters.start && chapter <= psalmInfo.chapters.end
  );
});
return {
  fixedBook: psalmInfo.name,
  fixedChapter: chapter - psalmInfo.chapters.start + 1,
};
