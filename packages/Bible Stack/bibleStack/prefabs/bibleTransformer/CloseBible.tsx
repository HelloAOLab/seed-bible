...
await Promise.allSettled([
  ...bibleElements.map((bibleElement: any) => {
...
if (elementsToShrink.length > 0) {
  try {
    await Promise.all(
      ...
      elementsToShrink.forEach((piece: any) => {
      ...
      if (sectionShadows.length > 0) {
        sectionShadows.forEach((piece: any) => {
