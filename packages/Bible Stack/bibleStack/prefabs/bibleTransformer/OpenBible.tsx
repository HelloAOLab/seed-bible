...
const crossVerticalLineScales = BibleVizUtils.Functions.GetBotScales(
...
let nextPositionZ =
  initialPositionZ + BibleVizUtils.Data.tags.StackSpacing.BetweenArrangements;
...
for (const testamentData of bibleData.childrenData) {
  ...
  for (const sectionData of testamentData.childrenData) {
    ...
    nextPositionZ +=
      desiredScaleZ + BibleVizUtils.Data.tags.StackSpacing.BetweenSections;
  }
