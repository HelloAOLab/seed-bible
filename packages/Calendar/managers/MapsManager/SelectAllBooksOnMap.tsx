...
const unselectedBooksData = thisBot.vars.mapBooksData.filter(
  (bookData: any) => {
    return bookData.element && !bookData.isSelected;
  }
);
await unselectedBooksData.sort(
  (bookDataA: any, bookDataB) =>
    bookDataA.element.tags.index - bookDataB.element.tags.index
);
