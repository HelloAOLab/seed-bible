...
export declare const FREE_USE_BIBLE_API_ENDPOINT = "https://bible.helloao.org/";
export declare function getDefaultAPIEndpoint(url: URL): string;
/**
...
export declare class FreeUseBibleAPI {
  endpoint: string;
  private _responseCache;
  private _requestSubscriptions;
