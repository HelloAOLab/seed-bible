 ...
 */
export declare function readInjectedConfig(): AppConfig;
/** Prefixes a root-relative app path with the deployment base path. */
export declare function withBasePath(config: AppConfig, path: string): string;
export declare const AppConfigProvider: import("preact").Provider<AppConfig>;
