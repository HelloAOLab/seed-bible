...
function createTranscriptionManager(
  ...
  function inferRefs(segments: InferSegment[]) {
    return inferRefsLib(seedBibleState.os, segments, minConfidence.value);
  }
  ...
  async function checkLogin(): Promise<void> {
    ...
    // Already authenticated from a restored session — no popup needed.
