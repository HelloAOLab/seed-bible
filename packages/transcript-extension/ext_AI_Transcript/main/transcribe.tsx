...
function bytesToBase64(data: Uint8Array): string {
  // Encode via `base64-js` rather than native `btoa`: it takes a byte array
  // directly (no String.fromCharCode round-trip that overflows the call stack
  // on large audio buffers) and works outside the AUX runtime.
