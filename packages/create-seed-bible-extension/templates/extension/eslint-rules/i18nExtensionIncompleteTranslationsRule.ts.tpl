...
// Vendored from the seed-bible monorepo's
// script/eslint/i18nExtensionIncompleteTranslationsRule.ts (only the
// `createRule` import path changed) — checks this project's extension.json
// for locales missing keys present in the `en` translation.
