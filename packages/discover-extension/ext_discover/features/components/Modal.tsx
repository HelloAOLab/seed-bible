import { featureModalCss } from "ext_discover.css.featureModalCss";
import { ImageWrapper } from "ext_discover.features.components.ImageWrapper";

export function Modal(props: Record<string, any>) {
  const {
    onClose,
    title,
    children,
