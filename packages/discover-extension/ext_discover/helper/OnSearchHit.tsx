import { findVerseByAI } from "ext_discover.helper.findVerseByAI";

export async function OnSearchHit(that?: any) {
  //  const results = await findVerseByAI({ query: searchText });
