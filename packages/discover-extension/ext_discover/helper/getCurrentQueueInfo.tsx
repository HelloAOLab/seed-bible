...
import { SetItemsPlayerPlaylist } from "ext_discover.helper.SetItemsPlayerPlaylist";
...
import { applyMobileHeaderBar } from "ext_discover.helper.applyMobileHeaderBar";

export function getCurrentQueueInfo(that: any) {
  ...
  if (targetItem?.type === "attachment-link") {
    ...
    if (
      ...
      const skip = checkIfNeedToSkip({ dataItem: targetItem });
      if (skip) {
