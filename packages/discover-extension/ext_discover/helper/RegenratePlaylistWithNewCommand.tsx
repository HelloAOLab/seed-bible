import { ConvertDataType } from "ext_discover.helper.ConvertDataType";

export async function RegenratePlaylistWithNewCommand(that?: any) {
  ...
  const { badData, allItems } = ConvertDataType({ results });
