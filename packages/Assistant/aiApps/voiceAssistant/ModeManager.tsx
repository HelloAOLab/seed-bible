  ...
  return (
    <div class="header-container">
      <div className="mode-container">
        {currentAIConfig.type === "webrtc" && !isFullScreen && (
          <button
            className={`mode-btn ${aiMode === "Voice" && "selected-mode"}`}
        ...
        {!isFullScreen && (
          <button
            className={`mode-btn ${aiMode === "Text" && "selected-mode"}`}
