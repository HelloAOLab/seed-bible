  ...
  return (
    <div class="available-events-item">
      ...
      {events.map((item, index) => {
        return (
          <div
            style={index === activeIndex ? { background: "#B3E5FC" } : {}}
            class="events-item"
...
const Repository = ({ selectedRepo }) => {
    ...
    return [
      {
        ...
        onClick: async ({ repoType }) => {
          ...
          if (App) {
            ...
            AddApplication({
              id,
              App: <App SelectedRepo={0} repoType={repoType} id={id} />,
              minWidth: "23rem",
            });
            // }
          }
      ...
      },
      {
        ...
        onClick: async ({ repoType }) => {
          ...
          if (App) {
            ...
            AddApplication({
              id,
              App: <App SelectedRepo={1} repoType={repoType} id={id} />,
              minWidth: "23rem",
            });
            // }
          }
      ...
      },
      {
        ...
        onClick: async ({ repoType }) => {
          ...
          if (App) {
            ...
            AddApplication({
              id,
              App: <App SelectedRepo={2} repoType={repoType} id={id} />,
              minWidth: "23rem",
            });
            // }
          }
      ...
      },
      {
        ...
        onClick: async ({ repoType }) => {
          ...
          if (App) {
            ...
            AddApplication({
              id,
              App: <App SelectedRepo={3} repoType={repoType} id={id} />,
              minWidth: "23rem",
            });
            // }
          }
      ...
      },
      {
        ...
        onClick: async ({ repoType }) => {
          ...
          if (App) {
            ...
            AddApplication({
              id,
              App: <App SelectedRepo={4} repoType={repoType} id={id} />,
              minWidth: "23rem",
            });
            // }
          }
      ...
      },
      {
        ...
        onClick: async ({ repoType }) => {
          ...
          if (App) {
            ...
            AddApplication({
              id,
              App: <App SelectedRepo={5} repoType={repoType} id={id} />,
              minWidth: "23rem",
            });
            // }
          }
      ...
      },
      {
        ...
        onClick: async ({ repoType }) => {
          ...
          if (App) {
            ...
            AddApplication({
              id,
              App: <App SelectedRepo={6} repoType={repoType} id={id} />,
              minWidth: "23rem",
            });
            // }
          }
  ...
  return (
    <div class="available-events-item">
      {events.map((item, index) => {
        return (
          <div class="events-item" onClick={item.onClick}>
            <span
              style={{ color: "var(--on-primary)" }}
              class="material-symbols-outlined"
            >
        ...
        web
          ...
          .then((e) => {
            ...
            if (e.data.status === 200) {
              os.getFile(e.data.data.recordAddress)
                .then((e) => {
                  ...
                  os.toast(
                    "Place the cursor anywhere you want to load animation",
                    3
                  );
                  setTagMask(
                    thisBot,
...
const Annotations = ({ page, setPage }: any) => {
  const [currentCursor, setCurrentCursor] = useState(null);
  const [loading, setLoading] = useState(true);
  const [currentPage, setCurrentPage] = useState(1);
  const [eventQuery, setEventQuery] = useState("");
  ...
  useEffect(() => {
    ...
    if (eventQuery !== "") {
      ...
      let queryUrl =
        "https://theographic-bible-api.netlify.app/api/annotations/getAnnotations";
      queryUrl = eventUtils.attachQueryToURL(queryUrl, params);
      web
        .hook({
          method: "GET",
