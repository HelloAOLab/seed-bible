...
const App = ({ aquiferData, prevData = [], selectedRepo }: any) => {
            ...
            <div class="bio-container">
              ...
              {aquiferData.group_origin &&
                aquiferData.group_origin.length > 0 && (
                  <>
                    ...
                    >
                      <div class="event-results">
                        {aquiferData.group_origin.map((item: any, index) => {
                          return (
                            <button
                              onClick={() => {
              ...
              {aquiferData.partners && aquiferData.partners.length > 0 && (
                <>
                  ...
                  >
                    <div class="event-results">
                      {aquiferData.partners.map((item: any, index) => {
                        return (
                          <button
                            onClick={() => {
                              LoadData({ uid: item.uid });
              ...
              {aquiferData.offspring && aquiferData.offspring.length > 0 && (
                <>
                  ...
                  >
                    <div class="event-results">
                      {aquiferData.offspring.map((item: any, index: any) => {
                        return (
                          <button
                            onClick={() => {
                              LoadData({ uid: item.uid });
              ...
              {aquiferData.siblings && aquiferData.siblings.length > 0 && (
                <>
                  ...
                  >
                    <div class="event-results">
                      {aquiferData.siblings.map((item: any, index: any) => {
                        return (
                          <button
                            onClick={() => {
                              LoadData({ uid: item.uid });
              ...
              {aquiferData.tribe && aquiferData.tribe.length > 0 && (
                <>
                  ...
                  >
                    <div class="event-results">
                      {aquiferData.tribe.map((item: any, index: any) => {
                        return (
                          <button
                            onClick={() => {
                              LoadData({ uid: item.uid });
              ...
              {aquiferData.possibly_same_as &&
                aquiferData.possibly_same_as.length > 0 && (
                  <>
                    ...
                    >
                      <div class="event-results">
                        {aquiferData.possibly_same_as.map(
                          (item: any, index: any) => {
                            return (
                              <button
                                onClick={() => {
              ...
              {aquiferData.referred_to_as &&
                aquiferData.referred_to_as.length > 0 && (
                  <>
                    ...
                    >
                      <div class="event-results">
                        {aquiferData.referred_to_as.map(
                          (item: any, index: any) => {
                            return (
                              <button
                                onClick={() => {
              ...
              {aquiferData.associated_places &&
                aquiferData.associated_places.length > 0 && (
                  <>
                    ...
                    >
                      <div class="event-results">
                        {aquiferData.associated_places.map(
                          (item: any, index: any) => {
                            return (
                              <button
                                onClick={() => {
