...
//#region node_modules/.pnpm/@preact+signals-core@1.14.0/node_modules/@preact/signals-core/dist/signals-core.module.js
...
Object.defineProperty(p$1.prototype, "value", {
  get: function () {
...
function k(i) {
  return function () {
    ...
    for (var o in n) if ("function" == typeof n[o]) n[o] = O(n[o]);
    n[Symbol.dispose] = O(function () {
...
//#endregion
//#region node_modules/.pnpm/@preact+signals@2.9.1_preact@10.29.8/node_modules/@preact/signals/dist/signals.module.js
var l$1,
  d,
  h,
  p = "undefined" != typeof window && !!window.__PREACT_SIGNALS_DEVTOOLS__,
  m = [],
  _ = [];
C(function () {
  l$1 = this.N;
...
function g$1(i, r) {
  l$2[i] = r.bind(null, l$2[i] || function () {});
}
function b(i) {
  if (h) {
    var n = h;
...
function y$1(i) {
  ...
  var f = T$1(function () {
      ...
      var o = g(function () {
        ...
        f = g(function () {
          return !Array.isArray(o.value) && !t$1(o.value);
        }),
        a = C(function () {
          this.N = F;
          if (f.value) {
            var n = o.value;
            if (i.__v && i.__v.__e && 3 === i.__v.__e.nodeType)
              i.__v.__e.data = n;
          }
        }),
        v = n.__$u.d;
...
y$1.displayName = "ReactiveTextNode";
...
function w(i, n, r, t) {
  var o = n in i && void 0 === i.ownerSVGElement,
    e = y(r),
    f = r.peek();
  return {
    o: function (i, n) {
...
function A() {
  n(function () {
    var i;
    while ((i = m.shift())) l$1.call(i);
  });
}
function T() {
  if (1 === m.push(this)) (l$2.requestAnimationFrame || k$1)(A);
}
function x() {
  n(function () {
    var i;
    while ((i = _.shift())) l$1.call(i);
  });
}
function F() {
  if (1 === _.push(this)) (l$2.requestAnimationFrame || q)(x);
}
