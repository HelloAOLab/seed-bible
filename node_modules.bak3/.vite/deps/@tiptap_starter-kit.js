import {
  _ as dropPoint,
  a as PluginKey,
  c as TextSelection$1,
  i as Plugin,
  k as Slice$1,
  o as Selection$2,
  r as NodeSelection$1,
  u as Mapping,
  w as Fragment$1,
...
import {
  ...
  Mt as isNodeActive,
  Nt as isNodeEmpty,
  Pt as isNodeSelection,
  R as findChildrenInRange,
  Ut as markInputRule,
  Wt as markPasteRule,
  Xt as nodeInputRule,
  Y as getChangedRanges,
  Z as getExtensionField,
  _n as keydownHandler,
  at as getNodeType,
  b as combineTransactionSteps,
  c as Mark$1,
  en as parseIndentedBlocks,
  gn as wrappingInputRule,
  i as Extension,
  in as renderNestedMarkdownContent,
  k as createStyleTag,
  mn as textblockTypeInputRule,
  nt as getMarksBetween,
  ot as getRenderedAttributes,
  q as getAttributes,
  qt as mergeAttributes,
  rt as getNodeAtPosition,
  u as Node3,
  v as callOrReturn,
  vn as Decoration,
  wt as isAtStartOfNode,
  y as canInsertNode,
  yn as DecorationSet,
} from "./dist-DQVaiYlO.js";
...
function replaceTwoWay($from, $to, depth) {
  ...
  if ($from.depth > depth)
    addNode(
      close(
        joinable($from, $to, depth + 1),
        replaceTwoWay($from, $to, depth + 1)
      ),
      content
    );
  addRange($to, null, depth, content);
...
var Node = class _Node {
  ...
  slice(from, to = this.content.size, includeParents = false) {
    ...
    return new Slice(
      $from.node(depth).content.cut($from.pos - start, $to.pos - start),
      $from.depth - depth,
      $to.depth - depth
    );
  }
...
var ReplaceStep = class _ReplaceStep extends Step {
  ...
  map(mapping) {
    ...
    let from =
      this.from == this.to && _ReplaceStep.MAP_BIAS < 0
        ? to
...
var TextSelection = class _TextSelection extends Selection$1 {
  ...
  static between($anchor, $head, bias) {
    ...
    if (!$head.parent.inlineContent) {
      let found2 =
        Selection$1.findFrom($head, bias, true) ||
        Selection$1.findFrom($head, -bias, true);
    ...
    if (!$anchor.parent.inlineContent)
      if (dPos == 0) $anchor = $head;
        ...
        $anchor = (
          Selection$1.findFrom($anchor, -bias, true) ||
          Selection$1.findFrom($anchor, bias, true)
        ).$anchor;
...
var handleBackspace$1 = (editor, type) => {
  ...
  if (
    previous.type !== type ||
    !((_a = previous.lastChild) == null ? void 0 : _a.isTextblock)
  )
    return false;
...
var Blockquote = Node3.create({
  ...
  renderMarkdown: (node, h) => {
    ...
    node.content.forEach((child, index) => {
      var _a, _b;
      const linesWithPrefix = (
        (_b =
          (_a = h.renderChild) == null ? void 0 : _a.call(h, child, index)) !=
        null
          ? _b
    ...
    return {
      language: {
        ...
        parseHTML: (element) => {
          ...
          const language = [
            ...(((_a = element.firstElementChild) == null
              ? void 0
              : _a.classList) || []),
          ]
  ...
  addKeyboardShortcuts() {
    return {
      ...
      Tab: ({ editor }) => {
        ...
        const tabSize =
          (_a = this.options.tabSize) != null ? _a : DEFAULT_TAB_SIZE;
        const { state } = editor;
        const { selection } = state;
      ...
      "Shift-Tab": ({ editor }) => {
        ...
        if (empty)
          return editor.commands.command(({ tr }) => {
            ...
            const lines = state.doc
              .textBetween(codeBlockStart, codeBlockEnd, "\n", "\n")
              .split("\n");
            ...
            const leadingSpaces =
              ((_a2 = lines[currentLineIndex].match(/^ */)) == null
                ? void 0
                : _a2[0]) || "";
        ...
        return editor.commands.command(({ tr }) => {
          const { from, to } = selection;
          const reverseIndentText = state.doc
            .textBetween(from, to, "\n", "\n")
            .split("\n")
            .map((line) => {
              var _a2;
              const leadingSpaces =
                ((_a2 = line.match(/^ */)) == null ? void 0 : _a2[0]) || "";
              const spacesToRemove = Math.min(leadingSpaces.length, tabSize);
              ...
              if (dispatch) {
                ...
                if ($to.nodeAfter)
                  if ($to.nodeAfter.isTextblock)
                    tr.setSelection(
                      TextSelection$1.create(tr.doc, $to.pos + 1)
                    );
                  ...
                  if (node) {
                    ...
                    tr.setSelection(
                      TextSelection$1.create(tr.doc, posAfter + 1)
                    );
                  }
                }
                tr.scrollIntoView();
    ...
    if (t) {
      if (groups) {
        if (nextState.t && typeof nextState.t === "string")
          addToGroups(
            t,
            Object.assign(flagsForToken(nextState.t, groups), flags),
            groups
          );
 ...
 * @param {Collections<T>} [groups]
 */
var ta = (state, input, next, flags, groups) =>
 ...
 * @param {Collections<T>} [groups]
 */
var tr = (state, regexp, next, flags, groups) =>
 ...
 * @param {Collections<T>} [groups]
 */
var ts = (state, input, next, flags, groups) =>
 ...
 * @param {Flags} [flags]
 */
var tt = (state, input, next, flags, groups) =>
...
function stringToArray(str) {
  ...
  while (index < len) {
    ...
    let char =
      ...
      first > 56319 ||
      index + 1 === len ||
      (second = str.charCodeAt(index + 1)) < 56320 ||
      second > 57343
        ? str[index]
...
Options.prototype = {
  ...
  render(token) {
    ...
    return (this.get("render", null, token) || this.defaultRender)(
      ir,
      token.t,
      token
    );
...
function init() {
  ...
  for (let i = 0; i < INIT.tokenQueue.length; i++)
    INIT.tokenQueue[i][1]({ scanner: INIT.scanner });
...
var UNICODE_WHITESPACE_REGEX_GLOBAL = new RegExp(
    ...
    props: {
      handleClick: (view, pos, event) => {
        ...
        if (options.enableClickSelection)
          handled = options.editor.commands.extendMarkRange(options.type.name);
    ...
    props: {
      handlePaste: (view, _event, slice) => {
        ...
        if (
          !textContent ||
          !link ||
          (shouldAutoLink !== void 0 && !shouldAutoLink(link.value))
        )
          return false;
...
var Link = Mark$1.create({
  ...
  renderMarkdown: (node, h) => {
    var _a, _b, _c, _d;
    const href =
      (_b = (_a = node.attrs) == null ? void 0 : _a.href) != null ? _b : "";
    const title =
      (_d = (_c = node.attrs) == null ? void 0 : _c.title) != null ? _d : "";
...
var handleDeleteBranchingNestedList = (editor, itemName, wrapperNames) => {
  return hoistBranchingNestedList(
    editor.state,
...
function isValidRoman(marker) {
  ...
  return (
    (marker === marker.toLowerCase() ? toRoman(value) : toRomanUpper(value)) ===
    marker
  );
}
...
function areOrderedListMarkersSequential(markers) {
  ...
  const firstType =
    (_a = detectMarkerType(markers[0])) != null ? _a : "numeric";
    ...
    return renderNestedMarkdownContent(
      ...
      (context) => {
        ...
        if (context.parentType === "orderedList") {
          const start =
            ((_b = (_a = context.meta) == null ? void 0 : _a.parentAttrs) ==
            null
              ? void 0
              : _b.start) || 1;
          return getListMarker(
            (_d = (_c = context.meta) == null ? void 0 : _c.parentAttrs) == null
              ? void 0
              : _d.type,
            start - 1 + (context.index || 0),
            ". "
          );
        }
        return "- ";
...
var hasListItemAfter = (typeOrName, state) => {
  ...
  if (
    ((_a = $targetPos.nodeAfter) == null ? void 0 : _a.type.name) !== typeOrName
  )
    return false;
  return true;
};
var hasListItemBefore = (typeOrName, state) => {
  ...
  if (
    ((_a = $targetPos.nodeBefore) == null ? void 0 : _a.type.name) !==
    typeOrName
  )
    return false;
  return true;
...
function parsePlainTextOrderedListPaste(text) {
  ...
  if (!areOrderedListMarkersSequential(parsedItems.map((item) => item.marker)))
    return null;
  return {
    type: "orderedList",
...
var TaskItem = Node3.create({
  ...
  renderMarkdown: (node, h) => {
    ...
    return renderNestedMarkdownContent(
      node,
      h,
      `- [${((_a = node.attrs) == null ? void 0 : _a.checked) ? "x" : " "}] `
    );
  },
  addExtensions() {
  ...
  addNodeView() {
    return ({ node, HTMLAttributes, getPos, editor }) => {
      ...
      const updateA11Y = (currentNode) => {
        ...
        checkbox.ariaLabel =
          ((_b =
            (_a = this.options.a11y) == null ? void 0 : _a.checkboxLabel) ==
          null
            ? void 0
  ...
  renderMarkdown: (node, h, ctx) => {
    ...
    if (content.length === 0) {
      const previousContent = Array.isArray(
        (_a = ctx == null ? void 0 : ctx.previousNode) == null
          ? void 0
          : _a.content
      )
        ? ctx.previousNode.content
        : [];
      return ((_b = ctx == null ? void 0 : ctx.previousNode) == null
        ? void 0
        : _b.type) === "paragraph" && previousContent.length === 0
      ...
      for (;;) {
        ...
        if (!inside) {
          if (
            next.isAtom &&
            !next.isText &&
            !NodeSelection$1.isSelectable(next)
          ) {
...
function handleClick(view, pos, event) {
  ...
  if (
    clickPos &&
    clickPos.inside > -1 &&
    NodeSelection$1.isSelectable(view.state.doc.nodeAt(clickPos.inside))
  )
    return false;
...
var Branch = class Branch {
      ...
      (item, i) => {
        ...
        if (remap) {
          ...
          if (step && transform.maybeStep(step).doc) {
            ...
            addAfter.push(
              new Item(map, void 0, void 0, addAfter.length + addBefore.length)
            );
          }
          mapFrom--;
  ...
  rebased(rebasedTransform, rebasedCount) {
    ...
    let branch = new Branch(
      this.items.slice(0, start).append(newMaps).append(rebasedItems),
      eventCount
    );
...
Extension.create({
  ...
  onBeforeCreate() {
    this.storage.characters = (options) => {
      const node =
        (options == null ? void 0 : options.node) || this.editor.state.doc;
      if (
        ((options == null ? void 0 : options.mode) || this.options.mode) ===
        "textSize"
      ) {
    ...
    return [
      new Plugin({
        ...
        filterTransaction: (transaction, state) => {
          ...
          if (this.storage.characters({ node: transaction.doc }) > limit)
            return false;
          return true;
        },
      }),
          ...
          decorations: ({ doc, selection }) => {
            ...
            if (this.options.mode === "deepest")
              doc.descendants((node, pos) => {
                ...
                if (!(anchor >= pos && anchor <= pos + node.nodeSize - 1))
                  return false;
                maxLevels += 1;
              });
            let currentLevel = 0;
...
function resolveEmptyNodeClass(emptyNodeClass, props) {
  return typeof emptyNodeClass === "function"
...
function buildPlaceholderDecorations({
  ...
  if (options.showOnlyCurrent && !options.includeChildren) {
    ...
    if (node && node.type.isTextblock && isNodeEmpty(node)) {
      const hasAnchor =
        anchor >= nodeStart && anchor <= nodeStart + node.nodeSize;
      decorations.push(
    ...
    const from =
      (_a = pluginState == null ? void 0 : pluginState.topPos) != null ? _a : 0;
    const to =
      (_b = pluginState == null ? void 0 : pluginState.bottomPos) != null
        ? _b
        : doc.content.size;
...
function getViewportBoundaryPositions({ view, scrollContainer }) {
  ...
  const visibleTop =
    Math.max(editorRect.top, containerRect.top) - VIEWPORT_OVERSCAN_PX;
  const visibleBottom =
    Math.min(editorRect.bottom, containerRect.bottom) + VIEWPORT_OVERSCAN_PX;
...
var viewportPluginState = {
  ...
  apply(tr, prev) {
    ...
    return {
      ...
      bottomPos:
        prev.bottomPos !== null ? tr.mapping.map(prev.bottomPos) : null,
    };
  },
};
function createViewportPluginView(view) {
  ...
  const computeAndDispatch = () => {
    ...
    if (
      (prev == null ? void 0 : prev.topPos) === positions.top &&
      (prev == null ? void 0 : prev.bottomPos) === positions.bottom
    )
      return;
  ...
  const intersectionObserver =
    typeof IntersectionObserver !== "undefined"
      ? new IntersectionObserver(scheduleFrame)
      : null;
...
var TrailingNode = Extension.create({
  ...
  addProseMirrorPlugins() {
    ...
    const defaultNode =
      this.options.node ||
      ((_a = this.editor.schema.topNodeType.contentMatch.defaultType) == null
        ? void 0
        : _a.name) ||
      "paragraph";
...
var StarterKit = Extension.create({
  ...
  addExtensions() {
    ...
    if (this.options.listKeymap !== false)
      extensions.push(
        ListKeymap.configure(
          (_a = this.options) == null ? void 0 : _a.listKeymap
        )
      );
    if (this.options.link !== false)
      extensions.push(
        Link.configure((_b = this.options) == null ? void 0 : _b.link)
      );
    if (this.options.orderedList !== false)
      extensions.push(OrderedList.configure(this.options.orderedList));
    ...
    if (this.options.underline !== false)
      extensions.push(
        Underline.configure((_c = this.options) == null ? void 0 : _c.underline)
      );
    if (this.options.trailingNode !== false)
      extensions.push(
        TrailingNode.configure(
          (_d = this.options) == null ? void 0 : _d.trailingNode
        )
      );
    return extensions;
  },
