import {
  useCallback as q,
  useEffect as h$1,
  useImperativeHandle as F,
  useRef as A,
  useState as d$1,
} from "./preact_hooks.js";
import gn, { forwardRef as D } from "./preact_compat.js";
//#region node_modules/.pnpm/react-avatar-editor@15.1.0_@preact+compat@18.3.2_preact@10.29.8__@preact+compat@18.3.2_preact@10.29.8_/node_modules/react-avatar-editor/dist/index.mjs
var s = (e, t, n, r, i, a) => {
    if (a === 0) e.rect(t, n, r, i);
      ...
      let o = r - a,
        s = i - a;
      (e.translate(t, n),
        e.arc(a, a, a, Math.PI, Math.PI * 1.5),
        e.lineTo(o, 0),
        e.arc(o, a, a, Math.PI * 1.5, Math.PI * 2),
        e.lineTo(r, s),
        e.arc(o, s, a, Math.PI * 2, Math.PI * 0.5),
        e.lineTo(a, i),
        e.arc(a, s, a, Math.PI * 0.5, Math.PI),
        e.closePath(),
        e.translate(-t, -n));
    }
  },
  c = (e, t, n, r, i, a) => {
    ...
    let o = r / 3,
      s = i / 3;
    (e.fillRect(t, n, 1, i),
      e.fillRect(o + t, n, 1, i),
      e.fillRect(o * 2 + t, n, 1, i),
      e.fillRect(o * 3 + t, n, 1, i),
      e.fillRect(o * 4 + t, n, 1, i),
      e.fillRect(t, n, r, 1),
      e.fillRect(t, s + n, r, 1),
      e.fillRect(t, s * 2 + n, r, 1),
      e.fillRect(t, s * 3 + n, r, 1),
      e.fillRect(t, s * 4 + n, r, 1));
  },
  l = (e) =>
    !!e.match(
  ...
  u = (e, t) =>
    new Promise((n, r) => {
      let i = new Image();
      (i.addEventListener("load", () => n(i)),
        i.addEventListener("error", r),
        !l(e) && t && (i.crossOrigin = t),
        (i.src = e));
    }),
  d = (e) =>
    new Promise((t, n) => {
  ...
  h = class {
    ...
    isVertical() {
      return (
        !this.config.disableCanvasRotation && this.config.rotate % 180 != 0
      );
    }
    getBorders(e) {
    ...
    getDimensions() {
      let { width: e, height: t, rotate: n, border: r } = this.config,
        i = {
          width: 0,
          height: 0,
        },
    ...
    getXScale() {
      if (!this.imageState.width || !this.imageState.height)
        throw Error("Image dimension is unknown.");
      let e = this.config.width / this.config.height,
        t = this.imageState.width / this.imageState.height;
      return Math.min(1, e / t);
    }
    getYScale() {
      if (!this.imageState.width || !this.imageState.height)
        throw Error("Image dimension is unknown.");
      let e = this.config.height / this.config.width,
        t = this.imageState.height / this.imageState.width;
      return Math.min(1, e / t);
    }
    getCroppingRect(e) {
      if (!this.imageState.width || !this.imageState.height)
      ...
      let t = e || {
        ...
        n = (1 / this.config.scale) * this.getXScale(),
        r = (1 / this.config.scale) * this.getYScale(),
        i = {
          x: t.x - n / 2,
          y: t.y - r / 2,
          width: n,
        ...
        c = 1 - i.height;
      return (
        (this.config.disableBoundaryChecks || n > 1 || r > 1) &&
          ((a = -i.width), (o = 1), (s = -i.height), (c = 1)),
        {
          ...i,
    ...
    calculatePosition(e = this.imageState, t) {
      ...
      let i = this.getCroppingRect(),
        a = e.width * this.config.scale,
        o = e.height * this.config.scale,
        s = -i.x * a,
        c = -i.y * o;
      return (
        this.isVertical() ? ((s += r), (c += n)) : ((s += n), (c += r)),
        {
          x: s,
          y: c,
          height: o,
    ...
    paint(e) {
      (e.save(),
        ...
        e.translate(0, 0),
        (e.fillStyle =
          "rgba(" + this.config.color.slice(0, 4).join(",") + ")"));
      let t = this.config.borderRadius,
        n = this.getDimensions(),
        [r, i] = this.getBorders(n.border),
        a = n.canvas.height,
        o = n.canvas.width;
      ((t = Math.max(t, 0)),
        (t = Math.min(t, o / 2 - r, a / 2 - i)),
        e.beginPath(),
        s(e, r, i, o - r * 2, a - i * 2, t),
        e.rect(o, 0, -o, a),
        e.fill("evenodd"),
        this.config.borderColor &&
          ...
          (e.lineWidth = 1),
          e.beginPath(),
          s(e, r + 0.5, i + 0.5, o - r * 2 - 1, a - i * 2 - 1, t),
          e.stroke()),
        this.config.showGrid &&
          c(e, r, i, o - r * 2, a - i * 2, this.config.gridColor),
        e.restore());
    }
    paintImage(e, t, n, r = this.pixelRatio) {
      ...
      (e.save(),
        ...
        e.rotate((this.config.rotate * Math.PI) / 180),
        e.translate(-(e.canvas.width / 2), -(e.canvas.height / 2)),
        this.isVertical() &&
          e.translate(
        ...
        this.config.backgroundColor &&
          ((e.fillStyle = this.config.backgroundColor),
          e.fillRect(0, 0, e.canvas.width, e.canvas.height)),
        e.restore());
    }
    getImage() {
      let e = this.getCroppingRect(),
        t = this.imageState;
      if (!t.resource)
        throw Error(
      ...
      this.isVertical()
        ? ((n.width = Math.round(e.height)), (n.height = Math.round(e.width)))
        : ((n.width = Math.round(e.width)), (n.height = Math.round(e.height)));
      ...
      return (
        ...
        r.rotate((this.config.rotate * Math.PI) / 180),
        r.translate(-(n.width / 2), -(n.height / 2)),
        this.isVertical() &&
          r.translate((n.width - n.height) / 2, (n.height - n.width) / 2),
        this.config.backgroundColor &&
          ((r.fillStyle = this.config.backgroundColor),
    ...
    getImageScaledToCanvas() {
      ...
      return (
        ...
        this.config.backgroundColor &&
          ((r.fillStyle = this.config.backgroundColor),
          r.fillRect(0, 0, n.width, n.height)),
        r.drawImage(t.resource, i.x, i.y, i.width, i.height),
        r.restore(),
        n
      );
    }
    calculateDragPosition(e, t, n, r) {
      ...
      if (!this.imageState.width || !this.imageState.height)
        throw Error("Image dimension is unknown.");
      let o = this.imageState.width * this.config.scale,
        s = this.imageState.height * this.config.scale,
        { x: c, y: l } = this.getCroppingRect();
      ((c *= o), (l *= s));
      ...
      let d = Math.cos(p(u)),
        ...
        m = c + i * d + a * f,
        h = l + -i * f + a * d,
        g = (1 / this.config.scale) * this.getXScale(),
        _ = (1 / this.config.scale) * this.getYScale();
      return {
        x: m / o + g / 2,
        y: h / s + _ / 2,
      };
  ...
  _ = () => {
    ...
    try {
      ...
      (window.addEventListener("test", g, t),
        window.removeEventListener("test", g, t));
    } catch {
      e = !1;
    }
    return e;
  ...
  v = D((t, s) => {
    let {
        ...
        showGrid: g = !1,
        gridColor: v = "#666",
        disableBoundaryChecks: y = !1,
        disableHiDPIScaling: b = !1,
        disableCanvasRotation: x = !0,
        image: S,
        position: C,
        backgroundColor: w,
        crossOrigin: T,
      ...
      [te, B] = d$1(!1),
      [V, H] = d$1(!1),
      [U, W] = d$1(I.current.getImageState()),
      G = A(j);
    G.current = j;
    let K = A(M);
    K.current = M;
    ...
    let J = q(() => {
      ...
      ne = q(() => {
        let e = J();
        (Y().clearRect(0, 0, e.width, e.height),
          I.current.clearImage(),
          W(I.current.getImageState()));
      }, [J, Y]),
      Z = q(() => {
        let e = Y(),
          t = J();
        (e.clearRect(0, 0, t.width, t.height),
          I.current.paint(e),
          I.current.paintImage(e, U, u));
      }, [Y, J, U, u, f, p, d, c, l, m, w, P, g, v, y, b, x, T]),
      re = q((e) => {
        (e.preventDefault(),
          (L.current = !0),
          (R.current = void 0),
    ...
    (F(
      ...
      h$1(() => {
        ...
        let t = (e) => {
            ...
            let t = "targetTouches" in e ? e.targetTouches[0].pageX : e.clientX,
              n = "targetTouches" in e ? e.targetTouches[0].pageY : e.clientY,
              r = R.current,
              i = z.current;
            if (
              ((R.current = t), (z.current = n), r !== void 0 && i !== void 0)
            ) {
          ...
          r = _() ? { passive: !1 } : !1;
        return (
          document.addEventListener("mousemove", t, r),
          document.addEventListener("mouseup", n, r),
          document.addEventListener("touchmove", t, r),
          document.addEventListener("touchend", n, r),
          () => {
      ...
      h$1(() => {
        ...
        let n,
          ...
          i = (a) => {
            let o = (a - r) / 1e3,
              s = 0.03 + Math.sin(o * 2.5) * 0.02 + 0.02;
            (t.save(),
    ...
    }, [S, f, p, C, c, l, U.x, U.y, A$1]);
    let $ = I.current.getDimensions(),
      ae = I.current.getPixelRatio(),
      oe = {
        width: $.canvas.width,
    ...
    return gn.createElement("canvas", {
