...
function mergeConfig$1(config1, config2) {
  ...
  utils_default.forEach(
    ...
    function computeConfigValue(prop) {
      ...
      (utils_default.isUndefined(configValue) && merge !== mergeDirectKeys) ||
...
axios.formToJSON = (thing) =>
  formDataToJSON(utils_default.isHTMLForm(thing) ? new FormData(thing) : thing);
axios.getAdapter = adapters_default.getAdapter;
axios.HttpStatusCode = HttpStatusCode$1;
axios.default = axios;
//#endregion
//#region node_modules/.pnpm/axios@1.13.5/node_modules/axios/index.js
var {
  Axios,
  AxiosError,
  CanceledError,
