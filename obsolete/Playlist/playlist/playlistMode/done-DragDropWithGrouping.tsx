...
const DragDrop = (props: any) => {
  ...
  const transformedHistory = useMemo(
    () => (layers ? groupVerse(list) : groupVerse(list)),
    [list, selectedCount, unSelectedCount]
  );

  // const transformedHistory = useMemo(() => playingPlaylist ? checkGreyOut(transformedHistory) : transformedHistory, [transformedHistory, toggle, playingPlaylist]);
