...
const UserSettings = ({
  ...
  return (
    <div class="card">
        ...
        {availableAgents.map((agent, index) => {
          return (
            <label class="agent">
              ...
              <input
                onChange={() => {
                  setCurrentAIConfig({ ...agent });
                }}
                type="radio"
                name="agent"
                checked={currentAIConfig.Name === agent.Name}
              />
            </label>
          );
        })}
      ...
      <button onClick={() => setOpenSettings(false)} class="start-btn">
        Start Talking
      </button>
      <button onClick={() => setOpenSettings(false)} class="cancel-btn">
        Cancel
      </button>
    </div>
  );
