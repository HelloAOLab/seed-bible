...
const searchBtnConfig = {
  ...
  form: "sprite",
  formAddress:
    "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/4e49f09ffd1137119fcca077fafb4a99d284a69a31e12426228da859e43f52b2.png",
  draggable: false,
  onCreate: `@
...
const aiSetting = {
  ...
  form: "sprite",
  formAddress:
    "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/b7a7724dd759a3d768a13f56afb23ec2c9ab6f167c3226bc0f57924134ca9e96.png",
  draggable: false,
  onCreate: `@
...
let options = [clearBot, button3Config];
...
for (let i = 0; i < options.length; i++) {
  let optionBot = create({
    ...options[i],
    [dim + "X"]:
      getBot(byID(that.id)).tags[dim + "X"] +
      1 * i -
      (options.length / 2 - 0.6),
  });
  await os.sleep(30);
}
