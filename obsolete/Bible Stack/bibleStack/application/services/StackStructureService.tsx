import type { StackStructureServicePort as PieceDragStackStructureServicePort } from "bibleStack.application.ports.scripturePieceDrag";
import type { StackStructureServicePort as PieceLifecycleStackStructureServicePort } from "bibleStack.application.ports.pieceLifecycle";
...
} from "bibleStack.application.ports.stackStructure";
...
const copyChapterStrategy: CopyStrategy<StackPieceDataMap["StackChapter"]> = ({
  ...
  return pieceLifecycleServicePort.createChapter({
    ...
    isHidden: true,
    bookName: data.getCreationParam("bookName"),
  });
};
