...
const zoom =
  isMobile && globalThis.SearchBarHideAndSeek
    ? 6
    : gridPortalBot.tags.cameraZoom;
...
try {
  await os.focusOn(
    {
      x: onlyZ
        ? gridPortalBot.tags.cameraFocusX
        : thisBot.tags[dimension + "X"] + shiftValueX,
      y: onlyZ
        ? gridPortalBot.tags.cameraFocusY
        : thisBot.tags[dimension + "Y"],
