...
jest.mock("scriptureMap2D.hooks.useIsMobile", () => ({
...
describe("useScriptureMap2DProvider", () => {
  ...
  function setup(config = makeConfig()) {
    const result = {
      current: null as unknown as ReturnType<typeof useScriptureMap2DProvider>,
    };

    function TestComponent() {
      result.current = useScriptureMap2DProvider(config);
      return null;
    }
