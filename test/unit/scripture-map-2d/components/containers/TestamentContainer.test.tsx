...
jest.mock("scriptureMap2D.hooks.useTestamentContainer", () => ({
...
jest.mock("scriptureMap2D.components.containers.TestamentToggle", () => ({
  TestamentToggle: ({
    toggleshowContent,
    showingContent,
  }: {
...
jest.mock("scriptureMap2D.components.containers.TestamentContent", () => ({
