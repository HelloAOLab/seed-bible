import { SectionInfoMapper } from "../../../../../packages/seed-bible-utils/infrastructure/mappers/SectionInfoMapper";
...
const makeBookInfoMapper = () => ({
  toDomain: vi.fn().mockReturnValue(makeDomainBook()),
  toInfrastructure: vi.fn(),
});
