...
- Let AI chat (Apologist and Bonfire) follow the active tab's Bible translation, with an optional pinned AI default and a fallback warning when Apologist cannot use that translation. ([#1265](https://github.com/HelloAOLab/seed-bible/issues/1265))
