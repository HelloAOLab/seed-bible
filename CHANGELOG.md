...
- Add an Ask AI action to the verse toolbar: select verses, pick an agent when more than one is available, and start a new chat with those verses already in the input.
