...
- Fix the page jerking sideways for a moment when you pick it up to swipe again straight after changing chapter. A finger movement from the previous swipe could arrive over a second late, while the new chapter was still being drawn, and was read as part of the new swipe. Late movements are now ignored. Swipes also no longer start with a small jump. ([#1558](https://github.com/HelloAOLab/seed-bible/issues/1558))
